...
import { generateBreadCrumbs } from "@/types/breadcrumbs";
...
const Career = () => {
	...
	return (
		<>
			<Helmet>
				<title>
					Career | ENYARD - Revolutionary AI Software Development Platform |
					Transform Your Business
				</title>
				<meta
					name="description"
					content="Shape the future of AI-powered software development. Work with cutting-edge technology and brilliant minds to create solutions that change the world."
				/>
				<link rel="canonical" href="https://enyard.in/career" />
