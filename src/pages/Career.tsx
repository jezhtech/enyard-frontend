...
import { MapPin, Clock, DollarSign, Users, Briefcase, GraduationCap, Coffee, Gamepad2 } from 'lucide-react';
  ...
  const positions = [
    {
      ...
      description: 'Lead development of AI-powered applications and mentor junior developers.'
    },
    {
      ...
      description: 'Design and implement AI solutions that power our innovative products.'
    },
    {
      ...
      description: 'Create intuitive and beautiful user experiences for our software solutions.'
    },
    {
      ...
      description: 'Build and maintain scalable cloud infrastructure for our applications.'
    },
    {
      ...
      description: 'Drive product vision and strategy for our innovative software solutions.'
    },
    {
      ...
      description: 'Learn and contribute to our frontend development with mentorship.'
    }
  ];
        ...
        <div className="container relative z-10 text-center">
          ...
          <div className="stagger-item" style={{ animationDelay: '0.2s' }}>
            <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto mb-12">
              Shape the future of AI-powered software development. Work with cutting-edge 
              technology and brilliant minds to create solutions that change the world.
            </p>
          </div>
        ...
        <div className="container relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {positions.map((position, index) => (
              <Card key={index} className="p-8 magnetic-card glass group hover:shadow-2xl transition-all duration-300">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                ...
                Our team is passionate about technology and committed to delivering 
                exceptional results while maintaining work-life balance.
              </p>
