  ...
  const docSections = [
    {
      ...
      description: 'Complete documentation for implementing and using TimeX attendance management system.',
      icon: Users,
      category: 'getting-started',
      docs: [
        { title: 'Quick Start Guide', type: 'guide', time: '5 min read' },
        { title: 'API Reference', type: 'api', time: '15 min read' },
        { title: 'Integration Tutorial', type: 'tutorial', time: '20 min read' },
        { title: 'Mobile App Setup', type: 'guide', time: '10 min read' }
      ]
    },
    {
      title: 'CoreX - ERP Solution',
      description: 'Comprehensive enterprise resource planning system documentation and guides.',
      icon: Database,
      category: 'integration',
      docs: [
        { title: 'System Architecture', type: 'guide', time: '12 min read' },
        { title: 'Module Configuration', type: 'tutorial', time: '25 min read' },
    ...
    },
    {
      ...
      description: 'Documentation for fleet booking and management system implementation.',
      icon: Smartphone,
      category: 'api',
      docs: [
    ...
    },
    {
      ...
      description: 'Complete guide for church management system setup and administration.',
      icon: Users,
      category: 'getting-started',
      docs: [
    ...
    },
    {
      ...
      description: 'Healthcare management system documentation with security and compliance guides.',
      icon: Shield,
      category: 'security',
      docs: [
        { title: 'HIPAA Compliance', type: 'guide', time: '20 min read' },
        { title: 'Patient Data API', type: 'api', time: '18 min read' },
        { title: 'Security Implementation', type: 'tutorial', time: '30 min read' },
        { title: 'Backup Procedures', type: 'guide', time: '12 min read' }
      ]
    },
    {
      title: 'Cloud Deployment',
      description: 'Guides for deploying ENYARD solutions on various cloud platforms.',
      icon: Cloud,
      category: 'deployment',
      docs: [
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          ...
          <div className="stagger-item max-w-2xl mx-auto" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="lg:col-span-3">
              <div className="space-y-8">
                {filteredSections.map((section, index) => (
                  <Card key={index} className="overflow-hidden magnetic-card glass">
                    <div className="p-8">
                            ...
                            >
                              ...
                              <div className="flex-1">
                                ...
                                <div className="flex items-center mt-1">
                                  <Badge 
                                    variant="outline" 
                                    className={`text-xs mr-2 ${getTypeBadge(doc.type)}`}
                                  >
      ...
      <section className="py-24 relative">
        ...
        <div className="container relative z-10 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-12">
            ...
            you get the most out of ENYARD solutions.
          </p>
