...
const Blog = () => {
	...
	const featuredPost = {
		title:
			"The Future of AI in Software Development: How ENYARD is Leading the Revolution",
		excerpt:
			"Discover how artificial intelligence is transforming the software development landscape and how ENYARD is pioneering innovative solutions that are changing the industry.",
		author: "John Smith",
		date: "2024-01-15",
		readTime: "8 min read",
	...
	const blogPosts = [
		{
			title:
				"Building Scalable Cloud-Native Applications with Modern Architecture",
			excerpt:
				"Learn the best practices for developing cloud-native applications that scale effortlessly and deliver exceptional performance.",
		...
		},
		{
			...
			excerpt:
				"Explore how low-code platforms are democratizing software development and enabling rapid application creation.",
			author: "Mike Chen",
			date: "2024-01-10",
			readTime: "5 min read",
		...
		{
			title:
				"Implementing AI-Powered Analytics in Healthcare Management Systems",
			excerpt:
				"Discover how AI analytics are revolutionizing healthcare management and improving patient outcomes.",
		...
		},
		{
			...
			excerpt:
				"Essential security measures every developer should implement to protect web applications from threats.",
		...
		},
		{
			...
			excerpt:
				"How AI is transforming enterprise resource planning systems and driving business efficiency.",
			author: "Lisa Wang",
			date: "2024-01-03",
			readTime: "6 min read",
			category: "Enterprise",
		...
		},
		{
			...
			excerpt:
				"The latest UX trends and design principles that will define user experiences in the coming year.",
			author: "David Kim",
			date: "2024-01-01",
			readTime: "5 min read",
			category: "Design",
					...
					<div className="container relative z-10 text-center">
						...
						<div className="stagger-item" style={{ animationDelay: "0.2s" }}>
							<p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto mb-12">
								Insights, tutorials, and thought leadership on AI, software
								development, and the future of technology innovation.
							</p>
						</div>
