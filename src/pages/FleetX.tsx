	...
	const features = [
		{
			...
			description:
				"AI-powered vehicle booking with automatic scheduling and conflict resolution",
			details: [
		...
		},
		{
			...
			description:
				"Advanced route planning with real-time traffic and fuel optimization",
			details: [
				"Traffic analysis",
				"Fuel optimization",
				"Multi-stop planning",
		...
		},
		{
			...
			description:
				"Comprehensive cost tracking and analytics with predictive insights",
			details: [
				"Fuel monitoring",
				"Maintenance costs",
				"Usage analytics",
		...
		},
		{
			...
			description:
				"Advanced security features with real-time monitoring and alerts",
			details: [
				"GPS tracking",
				"Theft protection",
				"Driver monitoring",
							...
							<div className="space-y-8">
								<div className="space-y-4">
									...
									<p className="text-xl text-muted-foreground max-w-lg">
										AI-integrated vehicle booking and rental software designed
										for external companies. Optimize routes, reduce costs, and
										streamline your entire fleet operation.
									</p>
								</div>
								...
								<div className="flex flex-wrap gap-4">
									...
									<Button
										...
										size="lg"
										onClick={() =>
											redirectToExternalSite("https://fcfleets.com/")
										}>
					...
					<div className="max-w-7xl mx-auto px-6">
						<div className="text-center mb-16">
							<h2 className="text-4xl font-bold mb-4">
								Intelligent{" "}
								<span className="text-gradient">Fleet Features</span>
							</h2>
					...
					<div className="max-w-7xl mx-auto px-6">
						...
						<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
							{useCases.map((useCase) => (
								<Card
									key={useCase.title}
									className="glass text-center p-6 hover-lift">
					...
					<div className="max-w-4xl mx-auto px-6 text-center">
						<div className="glass rounded-2xl p-12">
							...
							<p className="text-xl text-muted-foreground mb-8">
								Join companies saving millions with FleetX intelligent fleet
								management.
							</p>
