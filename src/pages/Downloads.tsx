  ...
  const featuredDownloads = [
    {
      ...
      description: 'Complete attendance management solution for iOS and Android devices.',
      version: 'v2.4.1',
    ...
    },
    {
      ...
      description: 'Full-featured ERP desktop application for Windows, macOS, and Linux.',
      version: 'v3.1.0',
    ...
    },
    {
      ...
      description: 'Complete API documentation with examples and SDK libraries.',
      version: 'v1.8.2',
  ...
  const downloads = [
    {
      ...
      description: 'Driver application for fleet management and booking system.',
      version: 'v1.9.3',
      platform: 'iOS & Android',
      size: '38.7 MB',
      downloads: '8K+',
    ...
    },
    {
      ...
      description: 'Desktop application for church management and administration.',
      version: 'v2.2.1',
        ...
        <div className="container relative z-10 text-center">
          ...
          <div className="stagger-item" style={{ animationDelay: '0.2s' }}>
            <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto mb-12">
              Access all ENYARD applications, documentation, resources, and tools. 
      ...
      <section className="py-24 relative">
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-gradient">Featured Downloads</h2>
            <p className="text-muted-foreground">Most popular and recently updated applications</p>
          </div>
          
          <div className="grid lg:grid-cols-3 gap-8">
            {featuredDownloads.map((download, index) => (
              <Card key={index} className="overflow-hidden magnetic-card glass-strong relative">
                ...
                <div className="p-8">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
                    ...
                    <div>
                      ...
                      <Badge className={`text-xs ${getTypeColor(download.type)}`}>
