	...
	const modules = [
		{
			...
			description:
				"Complete accounting, invoicing, and financial reporting with AI insights",
			features: [
							...
							<div className="space-y-8">
								<div className="space-y-4">
									...
									<p className="text-xl text-muted-foreground max-w-lg">
										...
										real-time analytics, and seamless integration across all
										business processes.
									</p>
								</div>
					...
					<div className="max-w-4xl mx-auto px-6 text-center">
						<div className="glass rounded-2xl p-12">
							...
							<p className="text-xl text-muted-foreground mb-8">
								Join industry leaders who trust CoreX for their enterprise
								resource planning.
							</p>
