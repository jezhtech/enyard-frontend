				...
				<main className="flex-grow">
					...
					<section className="relative h-[70vh] flex items-center justify-center text-center overflow-hidden bg-gradient-to-br from-gray-900 to-blue-900 text-white">
						...
						<div className="relative z-10 container mx-auto px-4">
							...
							<p className="text-lg md:text-xl max-w-3xl mx-auto mb-8 opacity-90">
								Empower cybersecurity enthusiasts with a single platform to
								master tools, explore vulnerabilities, and conquer challenges.
							</p>
							...
							<div className="grid md:grid-cols-2 gap-12 items-center">
								<div>
									...
									<p className="text-lg text-gray-300 mb-6">
										...
										education. Dive into interactive labs, master essential
										tools, and tackle real-world scenarios to build practical
										skills.
									</p>
								...
								<div className="grid md:grid-cols-2 gap-12 items-center">
									<div className="order-2 md:order-1">
										...
										<p className="text-lg text-gray-700 mb-6">
											{modules[activeModule].description} Explore the
											sub-modules and advanced topics within this domain.
										</p>
						...
						<div className="container mx-auto px-4 text-center">
							...
							<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
								{pricingTiers.map((tier, index) => (
									<Card
										key={tier.name}
										className={`bg-gray-800 text-white rounded-xl shadow-2xl border ${
											tier.highlight
                  ...
                  `}>
										...
										<CardContent className="p-8 pt-0">
											...
											<Button
												size="lg"
												className={`w-full text-lg px-8 py-3 shadow-lg ${
													tier.highlight
