...
import { Terminal, Bell, Code, User, Mail, Phone, X, CheckCircle } from "lucide-react";

const PenguinCountdown = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Notification request:', formData);
    setIsSubmitted(true);
    setTimeout(() => {
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <h3 className="text-lg font-mono font-bold text-gray-800 mb-2">
              ...
              <span className="text-blue-600">penguin</span> = {" "}
              <span className="text-green-600">"cybersecurity_platform"</span>;
            </h3>
            
            <p className="text-sm text-gray-600 font-mono">
              <span className="text-gray-500">//</span> Master tools, exploit vulnerabilities, become a security expert
            </p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <div className="text-center">
              ...
              <div className="text-xs text-gray-500 font-mono uppercase tracking-wider">DAYS</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-gray-500 font-mono uppercase tracking-wider">HRS</div>
            </div>
            <div className="text-gray-400 font-mono">:</div>
            <div className="text-center">
              <div className="text-2xl font-mono font-bold text-gray-800">
              ...
              <div className="text-xs text-gray-500 font-mono uppercase tracking-wider">MIN</div>
            </div>
            <div className="text-gray-400 font-mono">:</div>
            <div className="text-center">
              <div className="text-2xl font-mono font-bold text-gray-800">
              ...
              <div className="text-xs text-gray-500 font-mono uppercase tracking-wider">SEC</div>
            </div>
          </div>
          ...
          {!isSubmitted ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-3">
                <div>
                  <Label htmlFor="name" className="text-gray-300 text-sm font-mono">const name =</Label>
                ...
                <div>
                  <Label htmlFor="email" className="text-gray-300 text-sm font-mono">const email =</Label>
                  <div className="relative">
                ...
                <div>
                  <Label htmlFor="mobile" className="text-gray-300 text-sm font-mono">const mobile =</Label>
                  <div className="relative">
            ...
            <div className="text-center py-6">
              ...
              <h3 className="text-lg font-semibold text-white mb-2 font-mono">Success!</h3>
              <p className="text-gray-300 text-sm font-mono">
                // You're now on the notification list
                <br />
                // await penguin.launch();
              </p>
            </div>
          )}
        </DialogContent>
...
export default PenguinCountdown; 